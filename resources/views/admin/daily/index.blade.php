                ...
                @forelse($contents as $content)
                    <tr class="hover:bg-muted/50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('admin.daily.views', $content) }}"
                               class="inline-flex items-center gap-1 text-xs font-medium rounded-lg px-2 py-1 transition
                                      {{ ($content->views_count ?? 0) > 0 ? 'text-accent hover:bg-accent/10' : 'text-muted-text hover:text-secondary' }}">
               ...
               class="block hover:bg-muted/30 transition-colors active:scale-[0.99]">
                <div class="p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between text-xs text-muted-text pt-1 border-t border-border">
                        ...
                        <a href="{{ route('admin.daily.views', $content) }}"
                           class="inline-flex items-center gap-1 {{ ($content->views_count ?? 0) > 0 ? 'text-accent' : '' }}"
