...
<body class="min-h-screen bg-surface text-primary font-sans"
    ...
    <div class="flex min-h-[calc(100vh-3.5rem)]">
        @php
            $links = [
                ['route' => 'admin.dashboard', 'label' => __('app.dashboard'), 'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 'super_admin' => true],
                ['route' => 'admin.members.index', 'label' => __('app.members'), 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', 'super_admin' => true],
                ['route' => 'admin.tour.index', 'label' => __('app.tour_management_nav'), 'icon' => 'M15 12a3 3 0 11-6 0 3 3 0 016 0zM2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z', 'super_admin' => true],
                ...
                ['route' => 'admin.audit.index', 'label' => __('app.audit_log'), 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'super_admin' => true, 'match' => 'admin.audit.*'],
                ...
                ['route' => 'admin.lectionary.index', 'label' => __('app.lectionary_nav'), 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', 'roles' => ['admin', 'editor']],
                ['route' => 'admin.synaxarium.index', 'label' => __('app.synaxarium_admin_title'), 'icon' => 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z', 'roles' => ['admin', 'editor']],
                ['route' => 'admin.volunteer-invitations.index', 'label' => __('app.volunteer_invitations'), 'icon' => 'M21 12h-5l-1.5 4-2.5-1.5L8 18l.5-3.5L5 13V9.5l3.5-.5L9 5.5l4.5 2 2.5-1.5L16 10h5m-7-7v4', 'roles' => ['admin', 'editor']],
                ...
                ['route' => 'admin.himamat.index', 'label' => __('app.himamat_title'), 'icon' => 'M12 8c1.104 0 2-.896 2-2V4a2 2 0 10-4 0v2c0 1.104.896 2 2 2zm0 0c-3.866 0-7 3.134-7 7v5h14v-5c0-3.866-3.134-7-7-7z', 'roles' => ['admin', 'editor', 'writer']],
                ['route' => 'admin.daily-suggestions.index', 'label' => __('app.daily_suggestions'), 'icon' => 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', 'roles' => ['admin']],
                ['route' => 'admin.announcement-suggestions.index', 'label' => __('app.announcement_suggestions'), 'icon' => 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', 'roles' => ['admin']],
                ['route' => 'admin.profile.edit', 'label' => __('app.my_profile'), 'icon' => 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z', 'roles' => ['admin', 'editor', 'writer']],
                ...
                ['route' => 'admin.banners.index', 'label' => __('app.banner_admin_title'), 'icon' => 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z', 'super_admin' => true],
                ['route' => 'admin.referrals.index', 'label' => __('app.referrals'), 'icon' => 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-1.102-4.828a4 4 0 015.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1', 'super_admin' => true],
                ['route' => 'admin.feedback.index', 'label' => __('app.feedback_page_title'), 'icon' => 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', 'roles' => ['admin', 'editor']],
                ['route' => 'admin.survey.index', 'label' => 'Fasika Survey', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'roles' => ['admin', 'editor']],
                ['route' => 'admin.fasika-greetings.index', 'label' => __('app.fasika_greeting_admin_title'), 'icon' => 'M4.75 6.75h14.5v10.5H4.75V6.75zm7.25-3v3m0 10.5v3m7.25-7.25h3m-20.5 0h3m12.56-5.31l2.12-2.12M4.32 18.68l2.12-2.12m0-8.49L4.32 5.95m15.11 12.73l-2.12-2.12', 'roles' => ['admin', 'editor'], 'match' => 'admin.fasika-greetings.*'],
                ['route' => 'admin.fasika-quiz.index', 'label' => __('app.fasika_quiz_admin_nav'), 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'roles' => ['admin', 'editor'], 'match' => 'admin.fasika-quiz.*'],
                ...
                ['route' => 'admin.advanced-suggestions.create', 'label' => __('app.advanced_suggest_nav'), 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'roles' => ['admin', 'editor', 'writer']],
                ...
                ['route' => 'admin.translations.index', 'label' => __('app.translations'), 'icon' => 'M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129', 'super_admin' => true],
                ['route' => 'admin.seo.index', 'label' => __('app.seo'), 'icon' => 'M21 12a9 9 0 11-18 0 9 9 0 0118 0zM3.6 9h16.8M3.6 15h16.8M12 3a15.3 15.3 0 010 18M12 3a15.3 15.3 0 000 18', 'super_admin' => true],
                ['route' => 'admin.whatsapp.template', 'label' => __('app.whatsapp_template_nav'), 'icon' => 'M7 8h10M7 12h10M7 16h6M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z', 'super_admin' => true, 'match' => 'admin.whatsapp.*'],
                ['route' => 'admin.telegram.settings', 'label' => __('app.telegram_settings'), 'icon' => 'M8 12h.01M12 12h.01M16 12h.01M4 4a2 2 0 012-2h12a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z', 'super_admin' => true, 'match' => 'admin.telegram.*'],
            ];
        @endphp
                ...
                <nav class="space-y-1 px-3 flex-1">
                    @foreach ($links as $link)
                        ...
                        <a href="{{ route($link['route']) }}"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition {{ $isActive ? 'bg-accent text-on-accent' : 'text-secondary hover:bg-muted' }}">
            ...
            <div class="w-64 py-4 h-full overflow-y-auto flex flex-col">
                <nav class="space-y-1 px-3 flex-1">
                    @foreach ($links as $link)
                        ...
                        @php $isActive = request()->routeIs($link['match'] ?? $link['route'].'*'); @endphp
                        <a href="{{ route($link['route']) }}"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition whitespace-nowrap {{ $isActive ? 'bg-accent text-on-accent' : 'text-secondary hover:bg-muted' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $link['icon'] }}"/></svg>
                            {{ $link['label'] }}
                        </a>
                    @endforeach
