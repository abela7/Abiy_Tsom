    ...
    <div class="flex min-h-[calc(100vh-3.5rem)]">
        @php
            $links = [
                ...
                ['route' => 'admin.volunteer-invitations.index', 'label' => 'Volunteer Invitations', 'icon' => 'M21 12h-5l-1.5 4-2.5-1.5L8 18l.5-3.5L5 13V9.5l3.5-.5L9 5.5l4.5 2 2.5-1.5L16 10h5m-7-7v4', 'roles' => ['admin', 'editor']],
