    ...
    <div class="flex min-h-[calc(100vh-3.5rem)]">
        @php
            $links = [
                ...
                ['route' => 'admin.fasika-greetings.index', 'label' => __('app.fasika_greeting_admin_title'), 'icon' => 'M4.75 6.75h14.5v10.5H4.75V6.75zm7.25-3v3m0 10.5v3m7.25-7.25h3m-20.5 0h3m12.56-5.31l2.12-2.12M4.32 18.68l2.12-2.12m0-8.49L4.32 5.95m15.11 12.73l-2.12-2.12', 'roles' => ['admin', 'editor']],
