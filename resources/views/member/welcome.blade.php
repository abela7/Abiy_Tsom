                        ...
                        <div>
                            ...
                            <div x-show="!whatsappRejected" class="mt-5">
                                <a href="https://wa.me/{{ $waPhone }}?text=YES"
                                   target="_blank"
                                   class="group w-full py-3.5 bg-[#25D366] text-white rounded-xl font-bold text-base hover:brightness-110 active:scale-[0.98] transition-all duration-150 shadow-lg shadow-[#25D366]/25 flex items-center justify-center gap-2.5">
