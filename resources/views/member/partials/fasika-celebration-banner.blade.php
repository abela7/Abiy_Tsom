...
<div class="relative rounded-3xl overflow-hidden px-5 py-6 text-center space-y-3">
    ...
    <div class="relative mx-auto flex max-h-36 w-full max-w-[7.5rem] justify-center sm:max-h-44 sm:max-w-[9rem]">
        <div class="pointer-events-none absolute inset-[-18%] opacity-25"
        ...
        <img src="{{ asset('images/Risen.svg') }}"
             ...
             class="relative z-10 h-auto max-h-36 w-full object-contain object-center drop-shadow-[0_0_24px_rgba(245,208,96,0.45)] sm:max-h-44"
             decoding="async">
    </div>
