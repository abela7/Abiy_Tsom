...
<div class="relative rounded-3xl overflow-hidden px-5 py-6 text-center space-y-3">
    ...
    <div style="position:absolute;top:50%;left:50%;width:560px;height:560px;border-radius:50%;
    ...
    <div class="relative mx-auto flex h-56 w-40 shrink-0 items-center justify-center overflow-visible min-h-0 min-w-0 sm:h-72 sm:w-48">
        <div class="pointer-events-none absolute inset-[-16%] opacity-[0.22]"
             style="animation: fasika-rays 28s linear infinite;">
            @for ($r = 0; $r < 12; $r++)
            <div style="position:absolute;top:50%;left:50%;width:2px;height:128px;
        ...
        <img src="{{ asset('images/Risen.svg') }}"
             ...
             class="relative z-10 flex max-h-full max-w-full min-h-0 min-w-0 items-center justify-center object-contain object-center drop-shadow-[0_0_40px_rgba(245,208,96,0.42)]"
             decoding="async"
             loading="lazy">
    </div>
