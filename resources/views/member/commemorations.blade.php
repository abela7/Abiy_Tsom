...
<div class="max-w-2xl mx-auto px-4 py-4 space-y-4">
    ...
    <div class="rounded-2xl bg-card border border-border shadow-sm overflow-hidden">
        <div class="px-5 py-5 text-center">
            <div class="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-accent/10 mb-3">
    ...
    <div class="rounded-2xl bg-card border border-border shadow-sm overflow-hidden">
        ...
        <div class="flex items-center gap-2.5 px-4 pt-4 pb-2">
            <div class="shrink-0 w-8 h-8 rounded-xl bg-sinksar/10 flex items-center justify-center">
                <svg class="w-4 h-4 text-sinksar" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
            </div>
        ...
        <div class="px-4 pb-4 space-y-3">
            ...
            <div class="flex items-start gap-3 {{ !$loop->first ? 'pt-3 border-t border-border' : '' }}">
                ...
                @else
                    <div class="shrink-0 w-14 h-14 rounded-xl bg-sinksar/10 flex items-center justify-center">
                        <svg class="w-7 h-7 text-sinksar" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <span class="block text-[11px] text-sinksar font-semibold mt-0.5">{{ __('app.synaxarium_annual_feast') }}</span>
