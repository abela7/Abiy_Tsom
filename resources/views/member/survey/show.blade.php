...
>
    ...
    <div class="space-y-1.5">
        ...
        <p class="text-xs text-muted-text text-right">
            Step <span x-text="step"></span> of {{ $feedback->calculateCurrentStep() > 0 ? 5 : 5 }}
        </p>
    </div>
        ...
        <div class="bg-card rounded-2xl border border-border shadow-sm p-5 space-y-5">
            ...
            <div class="flex justify-center gap-2 pt-1">
                @for ($i = 1; $i <= 5; $i++)
                    <button type="button"
                            @click="answers.q1 = {{ $i }}"
                            class="text-4xl transition-transform active:scale-90 touch-manipulation focus:outline-none"
                ...
                <div class="flex justify-center gap-2">
                    @for ($i = 1; $i <= 5; $i++)
                        <button type="button" @click="answers.q3 = {{ $i }}"
                                class="text-3xl transition-transform active:scale-90 touch-manipulation focus:outline-none"
            ...
            <div class="space-y-3">
                ...
                <div class="flex gap-3">
                    <button type="button" @click="answers.q4 = true"
                            ...
                            :class="answers.q4 === true ? 'border-accent bg-accent/8 text-accent' : 'border-border bg-muted/20 text-primary hover:border-accent/40'">
                        👍 &nbsp;Yes
                    </button>
                    <button type="button" @click="answers.q4 = false"
                            class="flex-1 py-3 rounded-xl border text-[14px] font-semibold transition touch-manipulation"
                            :class="answers.q4 === false ? 'border-accent bg-accent/8 text-accent' : 'border-border bg-muted/20 text-primary hover:border-accent/40'">
                        👎 &nbsp;No
                    </button>
                </div>
            </div>
        ...
        <div class="bg-card rounded-2xl border border-border shadow-sm p-5 space-y-4">
            ...
            <div class="flex gap-3">
                <button type="button" @click="answers.q6 = true"
                        ...
                        :class="answers.q6 === true ? 'border-accent bg-accent/8 text-accent' : 'border-border bg-muted/20 text-primary hover:border-accent/40'">
                    ✅ &nbsp;Yes, keep me connected
                </button>
                <button type="button" @click="answers.q6 = false"
                        class="flex-1 py-3 rounded-xl border text-[13px] font-semibold transition touch-manipulation"
                        :class="answers.q6 === false ? 'border-accent bg-accent/8 text-accent' : 'border-border bg-muted/20 text-primary hover:border-accent/40'">
                    No thanks
                </button>
            </div>
        </div>
