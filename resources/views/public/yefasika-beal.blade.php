            ...
            <div class="mt-4 space-y-4">
                ...
                <div x-show="generatedUrl" x-cloak class="space-y-3 rounded-xl border border-white/10 bg-zinc-900/50 p-4 ring-1 ring-inset ring-white/[0.04]">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:justify-center">
                        ...
                        <button type="button"
                                @click="copyGenerated()"
                                class="touch-manipulation inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-white/15 px-5 text-sm font-semibold text-zinc-200 transition hover:bg-white/[0.06] active:scale-[0.98]">
