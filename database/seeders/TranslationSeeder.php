...
class TranslationSeeder extends Seeder
{
    ...
    private function getKeysByPage(): array
    {
        return [
            ...
            'himamat' => [
                'himamat_title', 'himamat_eyebrow', 'himamat_invitation_message',
                'himamat_unavailable_title', 'himamat_unavailable_body',
                'himamat_preferences_title', 'himamat_preferences_intro',
                'himamat_preferences_master_title', 'himamat_preferences_master_body',
                'himamat_preferences_saved', 'himamat_preferences_timeline_hint',
                'himamat_timezone_label', 'himamat_timezone_value',
                'himamat_save_button',
                'himamat_slot_7am', 'himamat_slot_9am', 'himamat_slot_12pm',
                'himamat_slot_3pm', 'himamat_slot_5pm',
                'himamat_open_today', 'himamat_day_view_title',
                'himamat_timeline_hint', 'himamat_timeline_today_state',
                'himamat_previous_day', 'himamat_next_day', 'himamat_slots_label',
                'himamat_preview_banner', 'himamat_state_past',
                'himamat_state_current', 'himamat_state_future',
                'himamat_significance_title', 'himamat_reading_title',
                'himamat_bows_title', 'himamat_bows_offered',
                'himamat_bows_none', 'himamat_bows_manual_note',
                'himamat_prayer_title', 'himamat_slot_content_pending',
                'himamat_admin_subtitle', 'himamat_scaffold_action',
                'himamat_scaffold_success', 'himamat_admin_empty',
                'himamat_edit_title', 'himamat_updated',
                'himamat_editor_fix_errors', 'himamat_global_info_title',
                'himamat_global_info_hint', 'himamat_day_reminder_time',
                'himamat_day_reminder_time_hint', 'himamat_day_reminder_time_order_error',
                'himamat_day_reminder_title', 'himamat_day_reminder_title_hint',
                'himamat_day_reminder_managed_note', 'himamat_day_meaning_title',
                'himamat_ritual_intro_title', 'himamat_synaxarium_title',
                'himamat_synaxarium_auto_note', 'himamat_synaxarium_manual_note',
                'himamat_synaxarium_source_title', 'himamat_synaxarium_source_automatic',
                'himamat_synaxarium_source_automatic_help', 'himamat_synaxarium_source_manual',
                'himamat_synaxarium_source_manual_help', 'himamat_synaxarium_annual',
                'himamat_synaxarium_monthly', 'himamat_synaxarium_empty',
                'himamat_synaxarium_entry_title', 'himamat_synaxarium_entry_hint',
                'himamat_synaxarium_entry_heading', 'himamat_synaxarium_entry_body',
                'himamat_faq_title', 'himamat_faq_intro',
                'himamat_faq_question', 'himamat_faq_answer',
                'himamat_faq_add', 'himamat_faq_remove',
                'himamat_faq_requires_english', 'himamat_faq_invalid',
                'himamat_timeline_editor_title', 'himamat_timeline_editor_hint',
                'himamat_hour_title', 'himamat_slot_reminder_title',
                'himamat_bible_reference', 'himamat_bible_passage',
                'himamat_bible_section_title', 'himamat_hour_resources_title',
                'himamat_hour_resources_hint', 'himamat_resource_add',
                'himamat_resource_remove', 'himamat_resource_empty',
                'himamat_resource_fallback', 'himamat_resource_type',
                'himamat_resource_type_video', 'himamat_resource_type_website',
                'himamat_resource_type_pdf', 'himamat_resource_type_photo',
                'himamat_resource_title', 'himamat_resource_url',
                'himamat_resource_url_hint', 'himamat_resource_url_optional_hint',
                'himamat_resource_upload', 'himamat_resource_current_file',
                'himamat_resource_open', 'himamat_resource_invalid',
                'himamat_resource_requires_media', 'himamat_resource_requires_url',
                'himamat_resource_upload_not_supported', 'himamat_photo_upload_invalid',
                'himamat_pdf_upload_invalid', 'himamat_reminder_reading_line',
                'himamat_reminder_prayer_line', 'himamat_reminder_bows_line',
                'himamat_reminder_open_line',
            ],
            'content_sections' => [
                ...
                'synaxarium_yearly_commemorations', 'synaxarium_monthly_commemorations',
                'synaxarium_annual_feast', 'synaxarium_no_saints_for_day',
                'synaxarium_tap_to_view', 'synaxarium_tap_more_detail',
            ...
            'tour' => [
                'tour_section_title', 'tour_section_desc',
                'tour_status_completed', 'tour_status_not_completed',
                'tour_show_again',
                'tour_welcome_title', 'tour_welcome_desc',
                'tour_language_title', 'tour_language_desc',
                'tour_theme_title', 'tour_theme_desc',
                'tour_next', 'tour_prev', 'tour_done', 'tour_skip',
                'tour_progress',
            ...
            'feedback' => [
                'feedback_page_title', 'feedback_subtitle',
                'feedback_name', 'feedback_name_ph',
                'feedback_email', 'feedback_email_optional', 'feedback_email_ph',
                'feedback_message', 'feedback_message_ph',
            ...
            'admin_translations' => [
                ...
                'group_himamat', 'group_week_detail', 'group_calendar', 'group_progress', 'group_tour', 'group_settings', 'group_telegram_bot', 'group_fundraising_popup', 'group_feedback', 'group_general',
