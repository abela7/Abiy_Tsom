    ...
    private function getKeysByPage(): array
    {
        return [
            ...
            'himamat' => [
                ...
                'himamat_preferences_saved', 'himamat_save_button',
                ...
                'himamat_day_view_title', 'himamat_open_today',
                'himamat_slots_label',
            ],
            'content_sections' => [
            ...
            'admin_other' => [
                ...
                'himamat_tracking_title', 'himamat_tracking_subtitle', 'himamat_tracking_campaign',
                'himamat_tracking_no_campaigns', 'himamat_tracking_search_placeholder',
                'himamat_tracking_total_sent', 'himamat_tracking_total_clicked',
                'himamat_tracking_total_not_clicked', 'himamat_tracking_total_preferences',
                'himamat_tracking_sent_at', 'himamat_tracking_clicked_at',
                'himamat_tracking_open_count', 'himamat_tracking_selected_slots',
                'himamat_tracking_unselected_slots', 'himamat_tracking_not_clicked',
                'himamat_tracking_no_preferences', 'himamat_tracking_empty',
            ],
            'admin_fundraising' => [
